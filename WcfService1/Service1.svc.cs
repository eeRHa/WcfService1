...
namespace WcfService1
{
    ...
    {
        SqlConnection con = new SqlConnection("Data source=LAPTOP-TT8EUJVL;Initial Catalog=MyTestDB;Persist Security info=true;User ID=sa;Password=123;Pooling=False");
